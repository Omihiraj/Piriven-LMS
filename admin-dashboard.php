...
<head>
  ...
  <script>
    function qtyLoad() {
      var qty = document.getElementById("teachers-qty").value;
      getTeachers(qty);
    }

    function getTeachers(no) {
      qty = no;
      document.getElementById("main-header").innerHTML = "Teachers Details"
      var xhttp = new XMLHttpRequest();
      xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
          var data = this.responseText;
          document.getElementById("all-dashboard").innerHTML = data;
        }
      };


      xhttp.open("POST", "menu/teachers.php", true);
      xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
      xhttp.send("no=" + qty);

    }

    function loadTeachAdd() {
      document.getElementById("main-teacher").style.display = "block";

    }
    var cT = document.getElementById("main-teacher");

    function closeTeacher() {
      document.getElementById("main-teacher").style.display = "none";
    }
    ...
    function addTeachers() {
      ...
      xhttp.open("POST", "menu/add-teacher.php", true);
      xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
      xhttp.send("index=" + index + "&name=" + name + "&email=" + email + "&contact=" + contact + "&pass=" + pass);
...
<body>
  <!-- ==================vvvvvvvvvvvvThis is Teacher Add Formvvvvvvvvvvvvv===================== -->
  <div id="main-teacher" class="mteacher">
    <div id='add-teacher'>
      <span class="t-close" id="t-close" onclick="closeTeacher()">&times;</span>
      <h3 align="center" id="teacher-head">Add New Teacher</h3>
      <input type='text' name='index-no' id='index-no' placeholder='Index No' required />
      <input type='text' name='name' id='name' placeholder='Teacher Name' required />
      <input type='text' name='email' id='email' placeholder='Teacher Email' required />
      ...
      <input type='button' id="t-submit" value='Submit' onclick="addTeachers()" />
    </div>
  </div>
  <!-- ==================^^^^^^^^^^^^This is Teacher Add Form^^^^^^^^^^^^===================== -->
  <div class="container">
    <div class="sidebar">
      <span class="logo">S</span>
      <a class="logo-expand" href="#">Damma LMS</a>
      <div class="side-wrapper">
        ...
        <div class="side-menu">
          ...
          <a class="sidebar-link trending" href="#" onclick="getTeachers(10)">
            <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <div class="side-wrapper">
        <div class="side-title">ACADEMY</div>
        <div class="side-menu">
          <a class="sidebar-link" href="#">
            <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <div class="wrapper">
      <div class="header">
        ...
        <div class="user-settings">
          <img class="user-img" src="img/admin.png" alt="">
      ...
      <div class="main-container">
        <div class="main-header anim" id="main-header" style="--delay: 0s">Dashboard</div>

        <div class="all-dashboard" id="all-dashboard">
